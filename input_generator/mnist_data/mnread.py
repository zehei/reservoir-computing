...
trdatafz='mnist_data/train-images-idx3-ubyte.gz'
trlabelfz='mnist_data/train-labels-idx1-ubyte.gz'
tstdatafz='mnist_data/t10k-images-idx3-ubyte.gz'
tstlabelfz='mnist_data/t10k-labels-idx1-ubyte.gz'
